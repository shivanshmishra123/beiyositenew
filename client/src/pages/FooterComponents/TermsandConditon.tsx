...
const TermsandConditon = () => {
  return (
    <div>    <div className='privacywrapper'>
  ...
  <p style={{marginBottom:'1rem'}}> This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name beiyo.in (“Website”), including the related mobile site and mobile application (hereinafter referred to as “Platform”).</p>
  <p style={{marginBottom:'1rem'}}> The Platform is owned by BEIYO TECHNVEN PRIVATE LIMITED , a company incorporated under the Companies Act, 1956 with its registered office at  Flat No. 1107 Topaz Btype, Rainbow Residency, Vallabhnagar Indore, Madhya Pradesh, 452003 India  (hereinafter referred to as "Platform Owner", "we", "us", "our").</p>
  ...
  <p style={{marginBottom:'1rem'}}> ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING.</p>
  <p style={{marginBottom:'1rem'}}> The use of Platform and/or availing of our Services is subject to the following Terms of Use: </p>
...
<li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Indore(M.P.)</li>
