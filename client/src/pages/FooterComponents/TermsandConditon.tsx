      ...
      <div className="privacywrapper">
        ...
        <div className="privacyMain">
          ...
          <p style={{ marginBottom: "1rem" }}>
            ...
            beiyo.in (“Website”), including the related mobile site and mobile
            application (hereinafter referred to as “Platform”).
          </p>
          <p style={{ marginBottom: "1rem" }}>
            {" "}
            The Platform is owned by BEIYO TECHNVEN PRIVATE LIMITED , a company
            incorporated under the Companies Act, 1956 with its registered
            office at Flat No. 1107 Topaz Btype, Rainbow Residency, Vallabhnagar
            Indore, Madhya Pradesh, 452003 India (hereinafter referred to as
        ...
        {/* refund policy  */}
        <br />
        <h1 className="privacyhead">Refund Policy</h1> <br />
        <div className="privacyMain">
          <p style={{ marginBottom: "1rem" }}>
