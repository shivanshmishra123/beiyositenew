  ...
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center pt-20">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20">
        ...
        {/* Optional Search Bar */}
        <div className="mt-12 bg-white shadow-lg rounded-lg p-6 lg:p-8 flex flex-col sm:flex-row items-center gap-4">
          <input
            type="text"
            placeholder="Enter location or preferences..."
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="flex-1 border border-gray-300 rounded-lg px-4 py-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-yellow-500"
          />
          <button
